...
export function Marquee({ text }) {
  return (
    <div style={{ overflow: "hidden", background: "#111", color: "#d4c5a9", padding: "10px 0", fontSize: 11, letterSpacing: 4, textTransform: "uppercase", fontFamily: "'Courier New', monospace" }}>
...
export function CursorFollower() {
  ...
  return (
      <div style={{ position: "fixed", left: pos.x - 15, top: pos.y - 15, width: 30, height: 30, border: "1px solid rgba(180,160,120,0.4)", borderRadius: "50%", pointerEvents: "none", zIndex: 9999, transition: "left 0.15s ease-out, top 0.15s ease-out, transform 0.2s", mixBlendMode: "difference" }} />
  );
}